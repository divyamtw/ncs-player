        ...
        <div className={styles.leftContent}>
          <div className={styles.logo}>
            <svg width="40" height="40" viewBox="0 0 40 40" fill="none">
              ...
              <path
                d="M26 14v8.5a3.5 3.5 0 1 1-2-3.15V14H26ZM17 24.5a1.5 1.5 0 1 0 3 0 1.5 1.5 0 0 0-3 0Z"
                fill="white"
              />
            </svg>
          ...
          <p className={styles.desc}>
            Create your admin account and start managing the NoCopyrightSounds
            catalog today.
          </p>
        </div>
      </div>
